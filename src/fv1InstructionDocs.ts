...
export const FV1_INSTRUCTIONS: Record<string, InstructionDoc> = {
    ...
    'sof': {
        name: 'SOF',
        syntax: 'SOF C, D',
        description: 'Scale and Offset. Multiplies ACC by C and adds D.',
    ...
    'and': {
        name: 'AND',
        syntax: 'AND mask',
        description: 'Logical AND operation with mask value.',
    ...
    'or': {
        name: 'OR',
        syntax: 'OR mask',
        description: 'Logical OR operation with mask value.',
        operands: 'mask: 24-bit mask value',
    ...
    'xor': {
        name: 'XOR',
        syntax: 'XOR mask',
        description: 'Logical XOR operation with mask value.',
        operands: 'mask: 24-bit mask value',
    ...
    'log': {
        name: 'LOG',
        syntax: 'LOG C, D',
        description: 'Logarithmic conversion. Converts linear ACC to log format.',
    ...
    'exp': {
        name: 'EXP',
        syntax: 'EXP C, D',
        description: 'Exponential conversion. Converts log ACC to linear format.',
        operands: 'C: Coefficient, D: Offset',
    ...
    'rdax': {
        name: 'RDAX',
        syntax: 'RDAX addr, C',
        description: 'Read from register, multiply by C, and add to ACC.',
    ...
    'wrax': {
        name: 'WRAX',
        syntax: 'WRAX addr, C',
        description: 'Write ACC to register, then multiply ACC by C.',
    ...
    'maxx': {
        name: 'MAXX',
        syntax: 'MAXX addr, C',
        description: 'Compare ACC with register, keep maximum value.',
    ...
    'mulx': {
        name: 'MULX',
        syntax: 'MULX addr',
        description: 'Multiply ACC by register value.',
    ...
    'rdfx': {
        name: 'RDFX',
        syntax: 'RDFX addr, C',
        description: 'Read shelving filter. Used for filter coefficient interpolation.',
    ...
    'wrlx': {
        name: 'WRLX',
        syntax: 'WRLX addr, C',
        description: 'Write shelving filter low. Used with WRHX for filter design.',
        operands: 'addr: Register address; C: Coefficient',
    ...
    'wrhx': {
        name: 'WRHX',
        syntax: 'WRHX addr, C',
        description: 'Write shelving filter high. Used with WRLX for filter design.',
        operands: 'addr: Register address; C: Coefficient',
    ...
    'rmpa': {
        name: 'RMPA',
        syntax: 'RMPA C',
        description: 'Read from delay memory at address pointer, multiply by C.',
    ...
    'wrap': {
        name: 'WRAP',
        syntax: 'WRAP addr, C',
        description: 'Write ACC to delay memory at address pointer, multiply by C.',
        operands: 'addr: Delay memory address (sets ADDR_PTR); C: Coefficient',
    ...
    'cho': {
        name: 'CHO',
        syntax: 'CHO type, lfo, flags, addr',
